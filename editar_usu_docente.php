			...
			<div class="right_col" role="main">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>Editar usuarios del docente</h2>
							...
							<div class="x_content">
								...
								<form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_docente.php">
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											...
											while ($res_b_docente = mysqli_fetch_array($b_docente)) {
												$id_u_docente = $res_b_docente['id'];
												if ($id_docente === $id_u_docente) {
												}
											} ?>
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="direccion" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_user['usuario']; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="correo" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_user['password']; ?>">
										</div>
									</div>
