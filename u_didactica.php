            ...
            <div class="right_col" role="main">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Registrar unidades didácticas</h2>
                            ...
                            <div class="x_content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Módulo :
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select type="text" name="modulo" class="form-control col-md-7 col-xs-12">
                                            <option value="">Seleccionar módulo</option>
                                            <?php 
                                            $b_mod = buscarModulo($conexion);
                                            while ($res_b_mod = mysqli_fetch_array($b_mod)) {
                                            ?> 
                                            <option value="<?php echo $res_b_mod['id']?>"> <?php echo $res_b_mod['descripcion']?> </option>
                                            <?php
                                            }
                                            ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select type="text" name="semestre" class="form-control col-md-7 col-xs-12">
                                            <option value="">Seleccionar semestre</option>
                                            <?php 
                                            $b_semestre = buscarSemestre($conexion);
                                            while ($res_b_sem= mysqli_fetch_array($b_semestre)) {
                                            ?> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="creditos" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="horas" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="tipo" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div><div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Orden :
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="orden" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                            </div>
