                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <ul class="nav navbar-right">
                                    <li>
                                        <a href="./u_didacticata.php" class="btn btn-success">Agregar Nuevo</a>
                                    </li>
                                </ul>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $res_b_ud['id_programa_estudio'];  ?></td>
                                                <td><?php echo $res_b_ud['id_modulo']; ?></td>
                                                <td><?php echo $res_b_ud['id_semestre']; ?></td>
