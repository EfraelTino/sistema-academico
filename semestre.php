                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <ul class="nav navbar-right">
                                    <li>
                                        <a href="./re_semestre.php" class="btn btn-success"><i class="fa fa-plus-square"> </i>  Agregar nuevo</a>
                                    </li>
                                </ul>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="./editar_semestre.php?id=<?php echo $res_b_semestre['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"> </i> Editar</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
