                                ...
                                <div class="x_title">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    <h2>Registrar condición<small></small></h2>
                                                    <div class="clearfix"></div>
                                                </div>
                                                <div class="x_content">
                                                    <form class="form-horizontal form-label-left" action="./operaciones/registrar_condicion.php" method="POST" id="formulario_docente">
                                                        ...
                                                        <div class="item form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <input id="condicion" class="form-control col-md-7 col-xs-12" name="condicion" placeholder="Ingrese la condición">
                                                            </div>
                                                        </div>
                                                        <br><br>
