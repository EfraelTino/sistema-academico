                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <ul class="nav navbar-right">
                                    <li>
                                        <a href="re_condicion.php" class="btn btn-success"><i class="fa fa-plus-square"> </i> Agregar nuevo</a>
                                    </li>
                                </ul>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="operaciones/delete_condicion.php?id=<?php echo $res_b_condicion['id']; ?>" class="btn btn-danger"><i class="fa fa-edit"> </i> Eliminar</a>
